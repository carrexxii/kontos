...
var key_map  : Table[KeyCode    , seq[KeyCallback]]
var mouse_map: Table[MouseButton, seq[MouseCallback]]
var motion_cbs = new_seq_of_cap[MotionCallback] DefaultKeyMaps
...
proc update*() =
    ...
    for event in events():
        ...
        of eventMouseButtonDown, eventMouseButtonUp:
            ...
            case btn
            of mbLeft  : ui_ctx.input_button bLeft  , pos.x, pos.y, was_down
            of mbMiddle: ui_ctx.input_button bMiddle, pos.x, pos.y, was_down
            of mbRight : ui_ctx.input_button bRight , pos.x, pos.y, was_down
            else:
                discard
